          ...
          <form method="POST" id="news_form" action="{{ route('news.store')}}"  role="form"  enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input  value="{{ old('feature_image')}}" type="file" data-max="8388608"
                class="form-control" id='feature_image' name="feature_image" required   />
              </div>
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Separate each tag with comma ',' e.g. great_news,grutto_company" name="tags" value="{{ old('tags')}}">
                </div>
              <div class="form-group">
